...
export const post = (url: string, body: string ) => request(`${BASE_URL}${url}`, {method: "POST", body})
export const patch = (url: string, body: string) => request(`${BASE_URL}${url}`, {method: "PATCH", body})
